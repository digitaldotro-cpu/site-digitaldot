      ...
      <Container>
        <AnimatedSection className="overflow-hidden rounded-[2rem] border border-[#2b454a] bg-[linear-gradient(145deg,rgba(16,23,28,0.95),rgba(8,11,14,0.98))] p-7 sm:p-9 lg:p-11">
          <div className="grid gap-9 lg:grid-cols-[0.9fr_1.1fr] lg:gap-12">
            <div>
              <span className="inline-flex rounded-full border border-[#276864]/28 bg-[#276864]/8 px-4 py-2 text-xs font-semibold uppercase tracking-[0.16em] text-[#d8c7a3]">
                Proof layer
              </span>
            ...
            <div className="grid gap-4">
              ...
              <div className="rounded-3xl border border-[#276864]/30 bg-[#276864]/8 p-5">
                <p className="text-xs font-semibold uppercase tracking-[0.16em] text-[#d8c7a3]">
                  {section.resultLabel}
                </p>
