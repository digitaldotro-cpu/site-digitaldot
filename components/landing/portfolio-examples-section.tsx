            ...
            >
              ...
              >
                <article className="grid h-full gap-7 lg:grid-cols-[0.82fr_1.18fr]">
                  <div className="relative flex min-h-48 items-center justify-center overflow-hidden rounded-[1.4rem] border border-[#276864]/40 bg-[#0b0c10] p-8">
                    <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_50%_45%,rgba(102,252,241,0.15),transparent_48%)]" />
                    <Image
                      src={study.heroImage}
