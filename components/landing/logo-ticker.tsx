...
export function LogoTicker({
  ...
  return (
    <div className="relative overflow-hidden rounded-2xl border border-[#276864]/35 bg-[#0f1418]">
      <div className="pointer-events-none absolute inset-y-0 left-0 z-10 w-10 bg-gradient-to-r from-[#0f1418] to-transparent sm:w-14" />
      <div className="pointer-events-none absolute inset-y-0 right-0 z-10 w-10 bg-gradient-to-l from-[#0f1418] to-transparent sm:w-14" />
