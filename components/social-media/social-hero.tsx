...
export function SocialHero({ badge, title, description, ctaLabel }: SocialHeroProps) {
  return (
    <section className="relative overflow-hidden pb-20 pt-20 sm:pb-24 sm:pt-24">
      <div className="pointer-events-none absolute right-0 top-0 h-64 w-64 rounded-full bg-[#276864]/12 blur-3xl" />
      <div className="grid items-center gap-10 lg:grid-cols-[1fr_1.02fr]">
        ...
        >
          <p className="text-xs font-bold uppercase tracking-[0.17em] text-[#d8c7a3]">
            {badge}
          </p>
        ...
        <motion.div
          ...
          className="relative"
        >
          <div className="relative overflow-hidden rounded-[1.9rem] border border-[#2d424a] bg-[linear-gradient(145deg,#15353a_0%,#163136_52%,#0f181d_100%)] p-4 shadow-[0_35px_95px_-50px_rgba(39,104,100,0.6)] sm:p-6">
            ...
            <div className="absolute bottom-7 left-7 rounded-2xl border border-[#2b3f47] bg-[#111b20]/85 px-4 py-3 backdrop-blur">
              <p className="text-[11px] font-semibold uppercase tracking-[0.12em] text-[#d8c7a3]">
                Pachet activ
              </p>
