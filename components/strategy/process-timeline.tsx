    ...
    <section className="border-y border-[#1a252d] bg-[#0d1217] py-20 sm:py-24">
      <div className="grid gap-8 lg:grid-cols-[0.9fr_1.1fr] lg:items-start">
        <div className="lg:sticky lg:top-24">
          <p className="text-xs font-semibold uppercase tracking-[0.14em] text-[#d8c7a3]">Proces</p>
          ...
          {steps.map((step, index) => (
            ...
            >
              <div className="flex items-start gap-4">
                <span className="inline-flex h-9 w-9 shrink-0 items-center justify-center rounded-full border border-[#2e4550] bg-[#0f1f28] text-sm font-semibold text-[#d8c7a3]">
