...
export function ServicePageLayout({ page, faqGroups }: ServicePageLayoutProps) {
  ...
  return (
    <>
      ...
      <section className="border-y border-[#1f2a2d] bg-[#101418]/64 py-18 sm:py-24" aria-labelledby="outcomes-title">
        <Container>
        ...
        <Container>
          ...
          <div className="mt-8 grid gap-5 md:grid-cols-2 lg:grid-cols-3">
            {page.problems.map((problem, index) => (
              <article key={problem.id} className="brand-card p-6">
      ...
      <section className="border-y border-[#1f2a2d] bg-[#101418]/64 py-14" aria-labelledby="related-services-title">
        <Container>
