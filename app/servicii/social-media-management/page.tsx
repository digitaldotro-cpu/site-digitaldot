...
export const metadata = buildMetadata({
  ...
  description:
    "Social Media Management cu strategie, producție și optimizare continuă pentru leaduri și poziționare premium.",
});
      ...
      <section className="py-16">
        <Container>
          ...
          <ol className="mt-8 grid gap-4 md:grid-cols-4">
            {page.sectionThreeItems.map((step, index) => (
              <li key={step} className="rounded-2xl border border-[#27373f] bg-[#10171b] p-5 text-[#d1d6da]">
                <p className="text-sm font-semibold text-[#66fcf1]">Pas {index + 1}</p>
